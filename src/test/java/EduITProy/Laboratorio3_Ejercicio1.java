...
public class Laboratorio3_Ejercicio1 {
    ...
    String URL_AUTH="http://www.automationpractice.pl/index.php?controller=authentication";
    ...
    public void registrarCuenta() {
        ...
        Assert.assertEquals(URL_AUTH, driver.getCurrentUrl());
    ...
    public void CapturaPantalla() throws Exception {
        ...
        FileUtils.copyFile(screen, new File("..\\EduITProy\\Evidencias\\pantalla.png"));
